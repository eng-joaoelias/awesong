  ...
  return (
    <>
      <section className='sidebar hero'>
        <h1 className='mb-5 text-lg font-semibold text-gray-600'>Top 5 curtidas</h1>
        {recommand.slice(0, 5).map((item, i) => (
          <div className='mb-3'>
            <Card_sm cover={item.cover} name={item.name} tag={item.tag} i={i} />
          </div>
        ))}
        <h1 className='mb-5 text-lg font-semibold text-gray-600 mt-5'>Baixe nosso App!</h1>
        ...
        <p className='text-sm mt-3'>Sobre Contatos Política de Privacidade</p>
